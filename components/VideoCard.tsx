...
export default function VideoCard({ video, onDownload }: VideoCardProps) {
  ...
  return (
    <article
      className="card overflow-hidden border border-base-300 bg-base-100 text-base-content shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
    ...
    >
      <figure className="relative aspect-video bg-base-300">
        ...
        <div className="absolute bottom-3 right-3 rounded bg-black/75 px-2 py-1 text-xs font-semibold text-white">
          {formatDuration(video.duration)}
        </div>

        {compressionPercentage > 0 && (
          <div className="absolute left-3 top-3 rounded bg-success px-2 py-1 text-xs font-semibold text-success-content">
      ...
      <div className="card-body gap-4 p-4">
        ...
        <div className="grid grid-cols-3 gap-2 text-xs">
          <div className="rounded border border-base-300 bg-base-200/60 p-2">
